...
const NavLink = ({ children, href = "#", className = "" }: { children: any; href?: string; className?: string }) => (
  <a href={href} className={`font-sans font-bold text-[13px] uppercase tracking-[0.12em] opacity-60 hover:opacity-100 transition-opacity whitespace-nowrap ${className}`}>
    {children}
  </a>
);
...
const InteractiveLab = () => {
  ...
  return (
    <div className="relative w-full aspect-video bg-lab-black group cursor-none"
      ...
      {/* Main Image */}
      <img 
        src="https://i.imgur.com/b8nsnJn.jpeg" 
...
export default function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-lab-red selection:text-white overflow-x-hidden bg-lab-white transition-colors duration-300">
      {/* Navigation - Deus Ex Machina Style */}
      <nav className={`fixed top-0 left-0 w-full z-50 px-8 transition-all duration-300 flex justify-between items-center bg-white/95 backdrop-blur-md border-b border-lab-line ${isScrolled ? 'py-2.5' : 'py-5'}`}>
        ...
        <div className="flex-1 flex justify-center">
          <div className={`transition-all duration-500 cursor-pointer ${isScrolled ? 'h-6' : 'h-10'}`}>
            <img 
              src="https://i.imgur.com/10OHHmC.png" 
              alt="Merchcraft Logo" 
        ...
        <div className="hidden lg:flex gap-8 items-center flex-1 justify-end">
          <div className="flex gap-4 items-center">
            ...
            <button className="bg-lab-red text-white px-5 py-2 rounded-full font-sans font-bold uppercase tracking-widest text-[12px] hover:bg-lab-black transition-all duration-300 shadow-lg">
              Begin Your Build
            </button>
          </div>
        </div>
      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col bg-white pt-24 overflow-hidden">
        ...
        <div className="flex-1 relative w-full overflow-hidden flex items-center justify-center">
          ...
          >
            <img 
              src="https://i.imgur.com/7HHyonU.jpeg" 
          ...
          <div className="relative z-10 text-center px-8 max-w-4xl mx-auto">
            ...
            >
              <button className="bg-white text-lab-black px-12 py-5 rounded-full font-sans font-bold uppercase tracking-widest text-[13px] hover:bg-lab-red hover:text-white transition-all duration-300 shadow-2xl">
                Enter Production
              </button>
            </motion.div>
          </div>
      ...
      <section className="py-24 px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-20">
          <ProjectCard 
            src="https://webstore.firestonewalker.com/cdn/shop/files/Tee_d2ae03d2-0a22-4d61-b5bf-13bccadb7025.jpg?v=1773161227&width=1225" 
            title="808 Heavyweight Tee" 
            category="01 / Firestone Walker" 
          />
          <ProjectCard 
            src="https://elwoodclothing.com/cdn/shop/files/EA0004-001-CHO_4_609x.progressive.jpg?v=1752526069" 
            title="Core Logo Hat" 
            category="02 / Elwood" 
            delay={0.1}
          />
          <ProjectCard 
            src="https://elwoodclothing.com/cdn/shop/files/ET00211-INK_4_609x.progressive.jpg?v=1765240881" 
        ...
        <div className="mt-16 flex justify-center">
          <button className="group flex items-center gap-4 border border-lab-black/10 px-12 py-6 rounded-full font-sans font-bold uppercase tracking-widest text-[12px] hover:bg-lab-black hover:text-white transition-all duration-500">
            View All Projects
      ...
      <footer className="bg-lab-white py-24 px-8 border-t border-lab-line transition-colors duration-300">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-20 mb-20">
          <div className="md:col-span-6">
            ...
            <button className="bg-lab-black text-white px-12 py-6 rounded-full font-sans font-bold uppercase tracking-widest text-[12px] hover:opacity-80 transition-opacity">
              Enter Production
            </button>
          </div>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="flex justify-between items-center mb-20">
              <div className="h-6">
                <img src="https://i.imgur.com/10OHHmC.png" alt="Logo" className="h-full" />
              </div>
              <X className="w-8 h-8 cursor-pointer" onClick={() => setIsMenuOpen(false)} />
            </div>
            <nav className="flex flex-col gap-8">
              {['Services', 'Showroom', 'Culture', 'Projects', 'Live Screen Printing'].map((item) => (
                <a 
                  key={item} 
                  href="#" 
              ...
              <button className="bg-lab-red text-white w-full py-6 rounded-full font-sans font-bold uppercase tracking-widest text-xs hover:bg-lab-black transition-all duration-300 shadow-lg mt-4">
                Begin Your Build
              </button>
            </nav>
